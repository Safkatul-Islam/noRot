...
export function buildStableRecommendationText(severity: Severity, persona: Persona): string {
  ...
  const messages: Record<Persona, Record<string, string[]>> = {
    ...
    tough_love: {
      nudge: [
        "BRUH. YOU'RE DRIFTING. WHAT THE HELL IS THE NEXT 2‑MINUTE STEP?",
      ...
      remind: [
        ...
        "THIS IS NOT 'A BREAK' — IT'S A TRAP. PICK THE NEXT STEP. NOW.",
      ...
      interrupt: [
        "STOP. LISTEN THE HELL UP. YOU'RE PROCRASTINATING. WHAT ARE YOU DOING IN THE NEXT 2 MINUTES?",
        "HARD STOP. CLOSE THE TAB. START THE TASK. YES, EVEN IF IT'S UGLY. GO. NO EXCUSES.",
        "YOU'RE NOT 'RESEARCHING.' YOU'RE AVOIDING. WHAT'S THE FIRST REAL STEP? GET STARTED.",
        "I CARE ABOUT YOU, BUT ALSO: GET IT TOGETHER. PICK ONE MICRO‑STEP. NOW. GO.",
      ],
      crisis: [
