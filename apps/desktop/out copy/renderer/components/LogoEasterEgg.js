...
export function LogoEasterEgg() {
    ...
    const handleMouseEnter = useCallback(() => {
        if (!svgRef.current || isAnimating.current)
            return;
    ...
    return (_jsx("div", { className: "flex items-center justify-center w-full h-20 mb-2", onMouseEnter: handleMouseEnter, children: _jsx(NorotLogo, { ref: svgRef, className: "w-20 h-20 cursor-pointer" }) }));
}
