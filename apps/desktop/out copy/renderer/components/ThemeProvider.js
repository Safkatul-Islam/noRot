...
export function ThemeProvider({ children }) {
    ...
    return (_jsx(ThemeContext.Provider, { value: { theme: 'dark' }, children: _jsxs("div", { className: "dark min-h-screen bg-background text-text-primary", children: [_jsx("div", { className: "fixed inset-0 z-0 pointer-events-none opacity-50", children: _jsx(LiquidEther, { colors: fluidParams.colors, resolution: 0.35, mouseForce: fluidParams.mouseForce, cursorSize: 80, autoDemo: true, autoSpeed: fluidParams.autoSpeed, autoIntensity: fluidParams.autoIntensity, autoResumeDelay: 500, autoRampDuration: 0.8 }, webglKey) }), _jsx("div", { className: "relative z-10", children: children })] }) }));
}
