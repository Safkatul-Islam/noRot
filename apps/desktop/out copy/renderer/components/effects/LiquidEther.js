...
export function LiquidEther({ mouseForce = 20, cursorSize = 100, isViscous = false, viscous = 30, iterationsViscous = 32, iterationsPoisson = 32, dt = 0.014, BFECC = true, resolution = 0.5, isBounce = false, colors = ['#5227FF', '#FF9FFC', '#B19EEF'], style = {}, className = '', autoDemo = true, autoSpeed = 0.5, autoIntensity = 2.2, takeoverDuration = 0.25, autoResumeDelay = 1000, autoRampDuration = 0.6, }) {
    ...
    const nuclearTimeoutRef = useRef(null);
    useEffect(() => {
        if (!mountRef.current)
            return;
...
`;
        ...
        class Advection extends ShaderPass {
            ...
            update({ dt: dtVal, isBounce: isBounceVal, BFECC: BFECCVal }) {
        ...
        class Pressure extends ShaderPass {
            ...
            update({ vel, pressure: pressureFbo }) {
                this.uniforms.velocity.value = vel.texture;
    ...
    return (_jsx("div", { ref: mountRef, className: className || '', style: {
            position: 'relative',
            overflow: 'hidden',
            width: '100%',
            height: '100%',
