...
/**
 * Glass tier system — each tier pairs opacity + blur + saturate for optical depth:
 *
 *   well:    Most transparent. Ether bleeds through. Heavy blur. Ambient/decorative.
 *   default: Standard frosted glass. Balanced readability + background visibility.
 *   dense:   Most opaque. Crisp text for data-heavy areas (charts, forms).
 */
...
export function GlassCard({
  ...
  const baseClassName = cn(
    ...
    v.bg, v.blur, v.saturate, v.shadow,
    ...
    'hover:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.9),0_0_20px_-10px_var(--color-glow-primary),inset_0_1px_0_rgba(255,255,255,0.08),inset_0_-1px_0_rgba(0,0,0,0.2)]',
  ...
  if (glow) {
    return (
      <MagicCard
        className={cn(
          baseClassName,
          'hover:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.9),0_0_32px_-8px_var(--color-glow-primary),inset_0_1px_0_rgba(255,255,255,0.08),inset_0_-1px_0_rgba(0,0,0,0.2)]'
        )}
        style={style}
      >
        {children}
