...
import type { AccentColorPreset } from '@/stores/settings-store';

function getPrimaryForeground(hexColor: string): string {
 ...
 */
export function useAccentColor(): AccentColorPreset {
